...
- §194Q SWEEP. After all other observations, walk every supplier / vendor account whose annual purchase aggregate (sum of debits to vendor / credits to your books) crosses Rs. 50 lakh. If no TDS deduction entry is visible against that vendor, emit a §194Q flag with at-risk amount = (aggregate − 50,00,000) × 0.001. Big trading / milling assessees often have 10+ vendors crossing this — do not stop after flagging one or two; cover all of them.
